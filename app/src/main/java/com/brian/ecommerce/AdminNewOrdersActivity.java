...
import com.brian.ecommerce.Model.AdminOrders;
...
public class AdminNewOrdersActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<AdminOrders ,AdminOrdersViewHolder> adapter
            ...
            @Override
            protected void onBindViewHolder(@NonNull AdminOrdersViewHolder adminOrdersViewHolder,  int i, @NonNull AdminOrders model) {
                adminOrdersViewHolder.userName.setText("Name: " + model.getName());
                adminOrdersViewHolder.userPhoneNumber.setText("Phone Number: " + model.getPhone());
                adminOrdersViewHolder.userShippingAddress.setText("Shipping Address: " + model.getAddress() + " "+ model.getCity());
                adminOrdersViewHolder.userDateTime.setText("Date : " + model.getDate() + " " + model.getTime());
