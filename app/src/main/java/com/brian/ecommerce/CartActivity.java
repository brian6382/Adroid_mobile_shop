...
import com.brian.ecommerce.Model.Cart;
import com.brian.ecommerce.Prevalent.Prevalent;
import com.brian.ecommerce.ViewHolder.CartViewHolder;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    if (shippingState.equals("shipped")){
                        ...
                        txtMsg1.setText("Congratulation your final order has been place successfully. soon your will received your order at your door step");

                        NextProcessBtn.setVisibility(View.GONE);

                        Toast.makeText(CartActivity.this, "you can purchase more product once you have received your first order", Toast.LENGTH_SHORT).show();
